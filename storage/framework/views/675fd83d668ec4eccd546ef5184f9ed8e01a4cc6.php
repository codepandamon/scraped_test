    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="<?php echo e(url('/dashboard')); ?>"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Dashboard
            </a>
...
</html><?php /**PATH C:\xampp\htdocs\test_final\resources\views/welcome.blade.php ENDPATH**/ ?>